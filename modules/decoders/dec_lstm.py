...
class LSTMDecoder(DecoderBase):
    ...
    def __init__(self, args, vocab, model_init, emb_init):
        ...
        self.loss = nn.CrossEntropyLoss(weight=vocab_mask, reduction='none') # reduce=False) # 
    ...
    def sample_text(self, input, z, EOS, device):
        ...
        while max_index != EOS and len(sentence) < 265:
    ...
    def beam_search_decode(self, z, K=5):
        ...
        for idx in range(batch_size):
            ...
            t = 0
            while len(completed_hypotheses) < K and t < 265:
                t += 1
    ...
    def sample_decode(self, z, greedy=False):
        ...
        length_c = 1
        while mask.sum().item() != 0 and length_c < 266:
